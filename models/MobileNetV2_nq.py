...
class InvertedResidual(nn.Module):
    def __init__(
        ...
        layers.extend([
            # dw
            ConvBNReLU(hidden_dim, hidden_dim, stride=stride, groups=hidden_dim, norm_layer=norm_layer, act_func=Q.ReLU()),
            # pw-linear
    ...
    def __init__(
        ...
        for t, c, n, s in inverted_residual_setting:
            ...
            for i in range(n):
                ...
                features.append(block(input_channel, output_channel, stride, expand_ratio=t, norm_layer=norm_layer, first=first))
                first = False
